...
app.addEventListener("click",e=>{
  ...
  if(e.target.id==="nm-roll-all"){s.dice={colors:Array.from({length:3},()=>nmRollDie(NM_DIE_COLORS)),numbers:Array.from({length:3},()=>nmRollDie(NM_DIE_NUMBERS))};nmSave(s);renderNochMal();return}
