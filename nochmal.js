...
function renderNochMal(){
  ...
  if(s.online&&s.turn?.choice?.[p.id]&&!s.turn?.done?.includes(p.id)){for(const k of nmPendingCells){document.querySelector('[data-nm-cell="'+k+'"]')?.classList.add("checked")}}
}
